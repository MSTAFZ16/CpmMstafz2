...
__CHANNEL_USERNAME__ = "t.me/mstafz16"
__GROUP_USERNAME__   = "t.me/sidali166"
...
def banner(console):
    ...
    brand_name = figlet_format('MSTAFZ CPM2', font='drpepper')
    colors = [
    ...
    console.print("[bold green]♕ MSTAFZ CPM2[/bold green]: Car Parking Multiplayer 2 Hacking Tool.")
